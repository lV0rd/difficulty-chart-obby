...
--[=[
	Gets a character from an instance
	@param instance Instance
	@return Model? Humanoid? -- Nil if not found
]=]

function CharacterUtils.getCharacterFromInstance(instance)
	local humanoid = instance.Parent:FindFirstChild("Humanoid")
	if humanoid then
		return instance.Parent, humanoid
	else
		humanoid = instance.Parent.Parent:FindFirstChild("Humanoid")
		if humanoid then
			return instance.Parent.Parent, humanoid
		else
			return nil, nil
		end
	end
